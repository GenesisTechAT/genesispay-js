...
GenesisPay (formerly GenesisPay) SDKs (`@genesis-tech/genesispay-seller`, `@genesis-tech/genesispay-agent`). No I/O, no framework
...
```bash
npm install @genesis-tech/genesispay-protocol
```
