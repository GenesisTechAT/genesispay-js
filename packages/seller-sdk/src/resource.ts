// What every GenesisPay resource module (checkout, plans, mandates) is built on:
...
// the base URL — the client owns those and hands down a bound `GenesisPayRequest`.
...
export type GenesisPayRequestOptions = {
  /** Defaults to GET. */
  ...
  /**
   * Filled into "Failed to reach GenesisPay to <action>" when the transport itself
...
export type GenesisPayRequest = (options: GenesisPayRequestOptions) => Promise<unknown>;
